		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non PO Vendor Invoice Request Rework",
									"targetURL": "#comsapcpdpainvwpoReworkUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapcpdpainvwpoReworkUI-display": {
								"semanticObject": "comsapcpdpainvwpoReworkUI",
								"action": "display",
								"description": "Non PO Vendor Invoice Request Rework",
								"title": "Non PO Vendor Invoice Request Rework",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cp.dpa.invwpo.ReworkUI",
									"url": sap.ui.require.toUrl("com/sap/cp/dpa/invwpo/ReworkUI")
								}
							}
						}
					}
