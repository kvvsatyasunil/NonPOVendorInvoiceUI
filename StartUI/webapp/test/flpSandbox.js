		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapcpdpainvwpoStartUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapcpdpainvwpoStartUI-display": {
								"semanticObject": "comsapcpdpainvwpoStartUI",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cp.dpa.invwpo.StartUI",
									"url": sap.ui.require.toUrl("com/sap/cp/dpa/invwpo/StartUI")
								}
							}
						}
					}
