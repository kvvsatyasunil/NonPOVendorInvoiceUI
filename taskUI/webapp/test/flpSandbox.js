		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non PO Vendor Invoice Request Approval",
									"targetURL": "#comsapcpdpainvwpotaskUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapcpdpainvwpotaskUI-display": {
								"semanticObject": "comsapcpdpainvwpotaskUI",
								"action": "display",
								"description": "Non PO Vendor Invoice Request Approval",
								"title": "Non PO Vendor Invoice Request Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cp.dpa.invwpo.taskUI",
									"url": sap.ui.require.toUrl("com/sap/cp/dpa/invwpo/taskUI")
								}
							}
						}
					}
